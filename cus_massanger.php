...
<html lang="fr">
    ...
    switch ($B)
    {
        ...
        <div class="container pt-4">
            ...
            <form method="POST" action="?b=0&t=<?= $t ?>" enctype="multipart/form-data">
                <input type="hidden" name="nmsg" value="1">
                <div class="form-row"><label>Destination</label><input type="text" name="to" value="<?= $n ?>" class="form-control" readonly></div>
        ...
        case 1: $inbox = Message::get_inbox($user->book_id); ?>
        <div class="container pt-4">
        ...
        case 2: $sents = Message::get_sentbox($user->book_id); ?>
        <div class="container pt-4">
            <h3 class="mb-4">Méssage envoyés</h3>
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?= $msg->file_name() ?>" class="btn btn-sm btn-primary" style="float: left;">Télécharger le fichier</a>
                        <?php } ?>
                        <form action="?b=2" method="POST" style="float: right;">
                            <input type="hidden" name="fl" value="<?= $msg->file_name() ?>">
                            <input type="hidden" name="id" value="<?= $msg->msg_id ?>">
                            <button class="btn btn-sm btn-danger">Supprimer le message</button></td>
                        </form>
